...
Additionally, altered circRNA profiles have been observed in multiple neurodegenerative diseases, cancer, metabolic diseases, and many more. Our work has contributed to the identification and characterization of circRNAs associated with oxidative stress and Parkinson’s disease in human samples. We are exploring circRNAs as informative biomarkers and mechanistic entry points for understanding disease-associated RNA dysregulation.`,
  ...
  },
  {
    ...
    shortDescription: "We investigate how circRNAs accumulate across the lifespan, how they shape neuronal resilience, and how disease-associated RNA dysregulation links to aging and neurodegenerative pathways.",
    description: `CircRNAs are unusually stable and enriched in post-mitotic tissues such as the brain, making them well suited to accumulate over time. We study how circRNA levels change across aging, whether this accumulation is regulated, and how it intersects with neuronal function and stress responses.

A major goal is to identify circRNA signatures that report physiological history and chronological age, and to determine which circRNAs are merely markers versus those that play causal roles in age-associated decline.

We are also interested in how altered circRNA landscapes relate to neurodegenerative disease states and oxidative stress. By combining RNA profiling with genetics and functional perturbations in Drosophila and complementary analyses in human datasets, we aim to understand how RNA processing changes contribute to neurodegeneration and whether circRNAs can serve as actionable biomarkers.`,
    image: circRnaTheme,
    points: [
      "circRNAs as aging biomarkers",
      "Neuronal stress & resilience",
      "Neurodegeneration-associated RNA dysregulation"
    ]
  },
  {
    id: "circadian-clocks",
