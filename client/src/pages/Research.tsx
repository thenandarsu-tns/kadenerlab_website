                ...
                <div className="glass-card h-full rounded-2xl overflow-hidden border border-white/5 hover:border-primary/50 transition-all duration-300 flex flex-col">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <img 
                      src={theme.image} 
                      alt={theme.title}
                      className={`w-full h-full transition-transform duration-700 group-hover:scale-105 ${(theme.id === 'circrnas' || theme.id === 'genomics' || theme.id === 'circadian-clocks' || theme.id === 'spatial-omics') ? 'object-contain bg-[#e8e4dc]' : 'object-cover'}`}
