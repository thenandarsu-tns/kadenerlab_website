            ...
            {resources.map((resource, index) => (
              ...
              >
                ...
                <div className="h-48 w-full bg-black/50 overflow-hidden relative group">
                  ...
                  {/* Category Badge */}
                  <div className="absolute top-3 left-3 bg-black/60 backdrop-blur-md border border-white/10 text-white text-xs font-medium px-2 py-1 rounded flex items-center gap-1.5">
